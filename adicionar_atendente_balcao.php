    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="POST" action="CRUD/create_atendente_balcao.php">
                        <fieldset>

                            <!-- Form Name -->
                            <legend>Cadastrar Novo Atendente</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="codigo" type="number" placeholder="" class="form-control input-md" >
                                </div>
                            </div>
