              ...
              <div class="table-responsive">
                <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php
                      ...
                      <a  href="gerar_relatorio.php?idRelatorio=<?=$row['id']?>"  class="btn btn-success" style="height:30px; font-size: 13px; margin: 1px; width: 80px; float: left; "> Gerar <i class="fas fa-print"></i></a>
