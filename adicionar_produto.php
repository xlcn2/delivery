    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
                    ...
                    <form class="form-horizontal" method="POST" action="CRUD/createProduto.php">
                        <fieldset>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="descricao" type="text" placeholder="" class="form-control input-md">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input name="codigo" type="text" placeholder="" class="form-control input-md" >
