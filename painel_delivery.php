    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
            <div class="row">
                    <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='pedido.php'">Novo <i class="fas fa-hamburger" ></i></button>
                  <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='pedido_recente.php'">Recentes <i class="fas fa-clock"></i></button>
                   <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='todos_pedidos.php'">Todos <i class="fas fa-list-ol"></i></button>
