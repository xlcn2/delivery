        ...
        <div class="container-fluid">
          ...
          <!-- Content Row -->
            <div class="row">
                  ...
                  <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='pedidoRecente.php'">Recentes <i class="fas fa-clock"></i></button>
                   <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='todosPedidos.php'">Todos <i class="fas fa-list-ol"></i></button>
