        ...
        <div class="container-fluid">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input name="valor" value="<?=$data['valorEntrega']?>" type="text" placeholder="" class="form-control input-md" onKeyPress="return(moeda(this,'.',',',event))">
            	...
            	if ($_POST)
            {
                ...
                $valorEntregafinal = str_replace($source, $replace, $valor); //remove os pontos e substitui a virgula pelo ponto
                    ...
                    $pdo = Banco::conectar();
                    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    $sql = "UPDATE bairro  set  nome= ?, valorEntrega= ? WHERE id = ?";
                    $q = $pdo->prepare($sql);
                    $q->execute(array($nome, $valorEntregafinal, $id));
                    Banco::desconectar();
                    echo"<script>  alert('Bairro Atualizado.');
