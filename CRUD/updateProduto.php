      ...
      <div id="content">
        ...
        <div class="container-fluid">
                    ...
                    <form class="form-horizontal" method="POST" >
                        <fieldset>
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="col-md-4 control-label" for="txtcodigo_produto_id">Descrição : </label>
                                <div class="col-md-8">
                                    <input name="descricao" value="<?=$data['descricao']?>" type="text" placeholder="" class="form-control input-md">
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label"  for="txtcodigo_produto_id" >Valor R$ : </label>
                                <div class="col-md-8">
              
                                    <input name="valor" value="<?=$data['valor']?>" type="text" placeholder="" class="form-control input-md" onKeyPress="return(moeda(this,'.',',',event))">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input name="codigo" type="text" value="<?=$data['id']?>" placeholder="" class="form-control input-md" >
                         ...
                         <div class="form-group col-md-8">
                            <label for="exampleFormControlSelect1">Categorias Cadastradas</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <button id="btnsalvar" type="submit" name="btnsalvar" class="btn btn-primary">Salvar
                                       ...
                                       <a id="btncancelar" onclick="location.href='../produto.php'"
            	...
            	if ($_POST)
            {
                    ...
                    $pdo = Banco::conectar();
                    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    $sql = "UPDATE lanche  set  nome= ?, descricao= ?, valor = ?, categoria = ?, id = ? WHERE id = ?";
                    $q = $pdo->prepare($sql);
                    $q->execute(array($nome, $descricao, $valorfinal, $categoria, $codigo, $idInicial));
                    Banco::desconectar();
