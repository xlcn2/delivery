...
require 'banco.php';
       ...
       $sql = "SELECT * FROM atendente_balcao where id = ?";
       $q = $pdo->prepare($sql);
       $q->execute(array($id));
        ...
        <div class="container-fluid">
            ...
            <form class="form-horizontal" method="POST">
                        <fieldset>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="txtcodigo_produto_id" >Codigo : </label>
                                <div class="col-md-8">
              
                                    <input name="codigo" value="<?=$data['codigo']?>" type="text" placeholder="" class="form-control input-md" >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <button id="btnsalvar" type="submit" name="btnsalvar" class="btn btn-primary">Salvar
                                     ...
                                     <a id="btncancelar" onclick="location.href='../atendente_balcao.php'"
            	...
            	if ($_POST)
            {
                  ...
                  $codigo = $_POST['codigo'];
                    ...
                    $pdo = Banco::conectar();
                    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    $sql = "UPDATE atendente_balcao  set  nome= ?, codigo= ? WHERE id = ?";
                    $q = $pdo->prepare($sql);
                    $q->execute(array($nome, $codigo, $id));
                    Banco::desconectar();
                    echo"<script>  alert('Atendete Atualizado.');
