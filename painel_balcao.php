      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Balcão</h1>
          ...
          <!-- Content Row -->
            <div class="row">
                  ...
                  <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='pedido_balcao.php'"><i class="fas fa-hotdog"></i> Novo Pedido</button>
                   <button type="button" class="btn bg-gray-800 text-gray-100 btMenu "  onclick="location.href='pedido_recente_balcao.php'"><i class="fas fa-clock"></i> Pedidos Efetuados </button>
